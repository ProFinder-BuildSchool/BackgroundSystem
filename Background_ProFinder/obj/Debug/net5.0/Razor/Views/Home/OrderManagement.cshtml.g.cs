#pragma checksum "C:\Users\User\Desktop\BackgroundSystem_Profinder\Background_ProFinder\Views\Home\OrderManagement.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "248333d0a236df99e52aa45fe900573a239fc046"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"248333d0a236df99e52aa45fe900573a239fc046", @"/Views/Home/OrderManagement.cshtml")]
    ...
    public class Views_Home_OrderManagement : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "C:\Users\User\Desktop\BackgroundSystem_Profinder\Background_ProFinder\Views\Home\OrderManagement.cshtml"
...
<div class=""container-fluid"" id=""app"">
    ...
    <div class=""card shadow mb-4"">
        <div class=""card-header py-3 d-flex flex-row justify-content-between"">
            <h6 class=""m-0 font-weight-bold text-primary table-title"">訂單資訊</h6>
...
");
        ...
        <div class=""modal-dialog modal-dialog-centered"" role=""document"">
            <div class=""modal-content"">
                ...
                <div class=""modal-body"">
                    <p>訂單編號：{{orderInfo.OrderID}}</p>
                    <p>案主姓名：{{orderInfo.ClientName}}</p>
                    <p>接案者姓名：{{orderInfo.StudioName}}</p>
                    <p>單價：{{orderInfo.PriceString}}</p>
                    <p>數量：{{orderInfo.Count}}</p>
                    <p class=""text-danger"">撥款金額：{{orderInfo.TotalStri");
        ...
        var app = new Vue({
            ...
            created: function () {
                ...
                axios({ method: ""Get"", url: ""/api/Order"" }).then(res => {
                    ...
                    co");
                WriteLiteral(@"nsole.log(this.allitems);
                });
            },
            watch: {
                items: function () {
